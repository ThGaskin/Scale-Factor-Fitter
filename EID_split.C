...
void EID_split(TString location, TString ptrange, TString EXTRA) {
  ...
  TMVA::Factory *factory = new TMVA::Factory( "EIDmva_"+location+"_"+ptrange+"_"+EXTRA, outputFile,
					      "!V:!Silent:Color:DrawProgressBar=False:AnalysisType=Classification");
...
//   factory->AddSpectator("PUweight_ouflow");
   ...
   //  Input File & Tree
   // -----------------------------
   TString input_signal_name = "/data/DATA/temp_pigard/eID/new_ntup_v1_DY_ext/new_ntup_v1_DY_ext_REG_signal_40.root";

...
// Wed Aug 24 14:22:42 2016 by ROOT version 5.34/30
// from TTree candTree/Event Summary
// found on file: ZZ4lAnalysis1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ZZ4lAnalysis1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ZZ4lAnalysis1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ZZ4lAnalysis1.root:/ZZTree");
